...
const info =
    <p>
        An XY pad is a two-dimensional control that can be connected to
        multiple parameters at once. It's a lot easier to create interesting
        sounds with this than with a bunch of sliders!
    </p>
