...
export default function BaseNode({ name, info, inputs, outputs, children, standalone = false }) {
    return (
        <div className="relative flex flex-col w-32 font-sans group">
            ...
            <div className="z-10 p-2 transition bg-white rounded shadow text-neutral-800 nodrag rounded-xl group-hover:shadow-lg"
